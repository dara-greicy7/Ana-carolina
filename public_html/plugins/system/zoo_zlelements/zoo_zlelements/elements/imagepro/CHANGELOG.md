...
### 3.3.8
  ...
  - Added possibility to render translated value of alt, caption, title

### 3.3.7

  - Updated lightbox media path

### 3.3.6

  - Fixed minor issue with Widgetkit2 integration
  - Fixed image remove button for UIkit templates
  - Added option to avoid getting smaller images resized

### 3.3.5

  - Fixed HTML validation
  - Fixed image preview on Submission Default layout
  - Fixed lightbox when using predefined default source
...
### 3.3.2
  ...
  - Added compatibility for custom edit sublayouts
...
### 2.6.0
  ...
  - Fixed Raw sublayout path params
...
### 2.5.3
  ...
  - Improved backend UI performance

...
defined('_JEXEC') or die;
	...
	// load assets
	$this->app->document->addScript('elements:mediapro/tmpl/submission/default/_sublayouts/_default/submission.min.js');
	...
	$exist = (int) file_exists(JPATH_SITE.'/'.$this->get('file'));
?>
...
<div class="download-element">
	...
	<div class="download-select">
		...
		<input type="hidden" class="upload" name="<?php echo $this->getControlName('upload'); ?>" value="<?php echo ($upload ? $this->index() : ''); ?>" data-exist="<?php echo $exist; ?>" />
	...
	jQuery(function($) {
		$('#<?php echo $this->identifier; ?>').MediaProSubmissionDefault();
	});
	</script>

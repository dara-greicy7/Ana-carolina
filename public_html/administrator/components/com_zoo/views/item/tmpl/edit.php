					...
					<div id="name-edit">
						...
						<div class="slug">
							...
							<div class="panel">
								...
								<input type="button" class="btn btn-small accept" value="<?php echo JText::_('Accept'); ?>"/>
				...
				<tr>
					...
					<td>
						...
						<span <?php echo !$this->item->hits ? 'style="display: none; visibility: hidden;"' : null; ?>>
							<input name="reset_hits" type="button" class="btn btn-small" value="<?php echo JText::_('Reset'); ?>" onclick="submitbutton('resethits');" />
						</span>
					</td>
				</tr>
				<tr>

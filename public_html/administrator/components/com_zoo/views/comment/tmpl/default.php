...
<div class="box-bottom">
	...
	<ul class="filter">
		<li class="filter-left">
			...
			<button class="btn btn-small" onclick="this.form.submit();"><?php echo JText::_('Search'); ?></button>
			<button class="btn btn-small" onclick="document.getElementById('search').value='';this.form.getElementById('filter_state').value='';this.form.submit();"><?php echo JText::_('Reset'); ?></button>
		</li>

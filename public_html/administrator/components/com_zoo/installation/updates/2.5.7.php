...
class Update257 implements iUpdate {
	...
	*/
	public function getNotifications($app) {
		...
		$msg = array();
		$msg[] = JText::_('This update will require you to <a href="https://yootheme.com/zoo/documentation/advanced/assign-elements-to-layout-positions">assign some new elements to your submission layouts.</a>');
		return $msg;

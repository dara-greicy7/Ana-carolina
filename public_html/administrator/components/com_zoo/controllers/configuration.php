...
class ConfigurationController extends AppController {
	...
	public function doImport() {
		...
		$frontpage_assignment = $this->app->request->get('frontpage-assign', 'array', array());
		$category_assignment = $this->app->request->get('category-assign', 'array', array());
		...
		if (JFile::exists($file)) {
			$this->app->import->import($file, $import_frontpage, $import_categories, $element_assignment, $types, $frontpage_assignment, $category_assignment);
		}

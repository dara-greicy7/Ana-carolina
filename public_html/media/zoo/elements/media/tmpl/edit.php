...
<div id="<?php echo $this->identifier; ?>">
    ...
    <div class="row">
		<?php echo $this->app->html->_('control.text', $this->getControlName('file'), $this->get('file'), 'placeholder="'.JText::_('File').'" class="file"'); ?>
    </div>
	...
	<div class="more-options">
		...
		<div class="poster options">
			...
			<div class="row">
				<?php echo $this->app->html->_('control.text', $this->getControlName('poster_image'), $this->get('poster_image'), 'class="image-select image-select-nopreview" title="'.JText::_('Poster image').'"'); ?>
			</div>

...
<div>
	...
	<div class="row">
        <?php echo $this->app->html->_('control.text', $this->getControlName('file'), $this->get('file'), 'class="image-select" title="'.JText::_('File').'"'); ?>
    	<span class="image-cancel"></span>
    	<button type="button" class="image-select"><?php echo JText::_('Select Image'); ?></button>
	...
	<div class="more-options">
		...
		<div class="lightbox options">
			...
			<div class="row">
				<?php echo $this->app->html->_('control.text', $this->getControlName('lightbox_image'), $this->get('lightbox_image'), 'class="image-select image-select-nopreview" title="'.JText::_('Lightbox image').'"'); ?>
			</div>
		...
		<div class="spotlight options">
			...
			<div class="row">
				<?php echo $this->app->html->_('control.text', $this->getControlName('caption'), $this->get('caption'), 'title="'.JText::_('Caption').'" placeholder="'.JText::_('Caption').'"'); ?>
			</div>

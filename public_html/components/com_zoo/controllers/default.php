...
class DefaultController extends AppController {
	...
	*/
	...
	public function item() {
		...
		$this->renderer = $this->app->renderer->create('item')->addPath($this->app->path->path('component.site:'));
        ...
        if ($this->template) {
            ...
            $view->addTemplatePath($this->template->getPath());
        }
	...
	public function category() {
		...
		$this->items      = $this->app->table->item->getByCategory($this->application->id, $ids, true, null, $this->item_order, $offset, $items_per_page, $ignore_priority);
		$item_count		  = $this->category->id == 0
            ? $this->app->table->item->getItemCountFromCategory($this->application->id, $category_id, true)
            : ($subcategories
